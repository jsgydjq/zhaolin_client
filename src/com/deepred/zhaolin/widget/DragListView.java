package com.deepred.zhaolin.widget;
...
public class DragListView extends ListView implements OnScrollListener,
	...
	private double mStartY, mMoveY;// 按下是的y坐标,move时的y坐标
	...
	void doActionMove(MotionEvent event) {
		...
		//double newRatio = Math.exp((mMoveY - mStartY) / 50);
		int offset =  (int) (13*(Math.log(mMoveY - mStartY + 1)));// / RATIO;
